import { get, post, del, upload, uploadPut } from './client.js'
...
export const uploadUrlDoc = (kbId, url) => post(`/knowledge-bases/${kbId}/documents/url`, { url })
export const recrawlDoc = (id) => post(`/documents/${id}/recrawl`, {})
